...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-navbar bg-white py-2">
      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          <div class="logo">
            <div class="site-logo">
              <a href="index.jsp" class="js-logo-clone">ShopMax</a>
            </div>
          </div>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <a href="shop.jsp">Shop</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Gray Shoe</strong></div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <p><a href="cart.jsp" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Add To Cart</a></p>
